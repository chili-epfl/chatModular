...
public class BurgerSystem {
	...
	public BurgerSystem() throws Exception {
		// Create the system
		...
		// Add the flow
		system.addModule(new FlowModule(new BurgerFlow()));
		
		// Load a grammar in the recognizer
		system.loadContext("default", new SpeechGrammarContext(new SRGSGrammar(system.getPackageFile("BurgerGrammar.xml"))));
